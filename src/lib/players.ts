...
export function vocationIds(vocation: string): PlayerVocation[] {
    switch (vocation.toLowerCase()) {
        ...
        case 'sorcerer':
            return [PlayerVocation.Sorcerer, PlayerVocation.MasterSorcerer, PlayerVocation.HeroicSorcerer, PlayerVocation.LegendarySorcerer];
        case 'druid':
            return [PlayerVocation.Druid, PlayerVocation.ElderDruid, PlayerVocation.HeroicDruid, PlayerVocation.LegendaryDruid];
        case 'paladin':
            return [PlayerVocation.Paladin, PlayerVocation.RoyalPaladin, PlayerVocation.HeroicPaladin, PlayerVocation.LegendaryPaladin];
        case 'knight':
            return [PlayerVocation.Knight, PlayerVocation.EliteKnight, PlayerVocation.HeroicKnight, PlayerVocation.LegendaryKnight];
        default:
            return [];
    }
}
...
export function isPlayerVocation(value: unknown): value is PlayerVocation {
    ...
    return (
        ...
        vocation === PlayerVocation.HeroicSorcerer ||
        vocation === PlayerVocation.HeroicDruid ||
        vocation === PlayerVocation.HeroicPaladin ||
        vocation === PlayerVocation.HeroicKnight ||
        vocation === PlayerVocation.LegendarySorcerer ||
        vocation === PlayerVocation.LegendaryDruid ||
        vocation === PlayerVocation.LegendaryPaladin ||
        vocation === PlayerVocation.LegendaryKnight
    );
}
...
export function vocationString(playerVocation: PlayerVocation): string {
    return {
        ...
        [PlayerVocation.HeroicSorcerer]: $_('vocations.heroic-sorcerer'),
        [PlayerVocation.HeroicDruid]: $_('vocations.heroic-druid'),
        [PlayerVocation.HeroicPaladin]: $_('vocations.heroic-paladin'),
        [PlayerVocation.HeroicKnight]: $_('vocations.heroic-knight'),
        [PlayerVocation.LegendarySorcerer]: $_('vocations.legendary-sorcerer'),
        [PlayerVocation.LegendaryDruid]: $_('vocations.legendary-druid'),
        [PlayerVocation.LegendaryPaladin]: $_('vocations.legendary-paladin'),
        [PlayerVocation.LegendaryKnight]: $_('vocations.legendary-knight'),
    }[playerVocation];
}
